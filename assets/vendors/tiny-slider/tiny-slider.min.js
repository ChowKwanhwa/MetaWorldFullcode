var tns = function() {
    ...
    var a = !1;
    try {
        var r = Object.defineProperty({}, "passive", { get: function() { a = !0 } });
    ...
    var $i = function(H) {
        ...
        var y = e.tC ? Bi(e.tC) : Si(e, "tC", function() {
                ...
                try {
                    for (var o, r = "(10px * 10)", u = ["calc" + r, "-moz-calc" + r, "-webkit-calc" + r], l = 0; l < 3; l++)
                        if (o = u[l], i.style.width = o, 100 === i.offsetWidth) { a = o.replace(r, ""); break }
                } catch (t) {}
        ...
        if (d.forEach(function(t) {
            ...
            W || ! function t(e) { for (var n in e) W || ("slideBy" === n && (e[n] = "page"), "edgePadding" === n && (e[n] = !1), "autoHeight" === n && (e[n] = !1)), "responsive" === n && t(e[n]) }(H), W || (H.axis = "horizontal", H.slideBy = "page", H.edgePadding = !1, k = H.animateIn, R = H.animateOut, v = H.animateDelay, I = H.animateNormal);
            ...
            var N, L, B, S, K, J, U, _, Z, $, tt, et, nt, it, at, ot, rt, ut, lt, st, ct, ft, dt, pt, vt, ht, mt, yt, gt, xt, bt, wt, Ct, Mt, Tt, Et, At, Nt, Lt, Bt, St, Ht, Ot, Dt = H.autoWidth,
                ...
                pe = "",
                ve = "",
                he = kt ? function() { return zt && !Qt ? Q - 1 : Math.ceil(-ce / (kt + It)) } : Dt ? function() {
                    for (var t = 0; t < le; t++)
                        if (N[t] >= -ce) return t
                } : function() { return zt && W && !Qt ? Q - 1 : Qt || W ? Math.max(0, le - Math.ceil(Wt)) : le - 1 },
                me = en(sn("startIndex")),
                ye = me,
                ge = (tn(), 0),
                xe = Dt ? null : he(),
            ...
            qe && ($ = H.controlsContainer, tt = H.controlsContainer ? H.controlsContainer.outerHTML : "", et = H.prevButton, nt = H.nextButton, it = H.prevButton ? H.prevButton.outerHTML : "", at = H.nextButton ? H.nextButton.outerHTML : ""), Fe && (ut = H.navContainer, lt = H.navContainer ? H.navContainer.outerHTML : "", ct = Dt ? Q : Mi(), ft = 0, dt = -1, pt = an(), vt = pt, ht = "tns-nav-active", mt = "Carousel Page ", yt = " (Current Slide)"), Ve && (gt = "forward" === H.autoplayDirection ? 1 : -1, xt = H.autoplayButton, bt = H.autoplayButton ? H.autoplayButton.outerHTML : "", wt = ["<span class='tns-visually-hidden'>", " animation</span>"]), (Ge || Qe) && (Nt = {}, St = !(Lt = {}), Ot = F ? function(t, e) { return t.x - e.x } : function(t, e) { return t.y - e.y }), Dt || $e(Le || He), o && (de = o, pe = "translate", ve = r ? (pe += F ? "3d(" : "3d(0px, ", F ? ", 0px, 0px)" : ", 0px)") : (pe += F ? "X(" : "Y(", ")")), W && (V.className = V.className.replace("tns-vpfix", "")),
                function() {
                    ...
                    Ae += " tns-" + H.axis, V.className += Ae, W ? ((M = O.createElement("div")).id = Ne + "-mw", M.className = "tns-ovh", T.appendChild(M), M.appendChild(j)) : T.appendChild(j); { Xt && ((M || j).className += " tns-ah") }
                    if (E.insertBefore(T, V), j.appendChild(V), Ii(G, function(t, e) { zi(t, "tns-item"), t.id || (t.id = Ne + "-item" + e), !W && I && zi(t, I), ji(t, { "aria-hidden": "true", tabindex: "-1" }) }), ue) {
            ...
            var _e = Qt ? W ? function() {
                    ...
                    if (xe < me)
                        ...
                        for (; me <= xe - Q;) me += Q
                } : function() { me = Math.max(ge, Math.min(xe, me)) },
                Ze = W ? function() {
                    var e, n, i, a, t, o, r, u, l, s, c;
                    Jn(V, ""), x || !Vt ? (ti(), Vt && Yi(V) || ai()) : (e = V, n = de, i = pe, a = ve, t = Zn(), o = Vt, r = ai, u = Math.min(o, 10), l = 0 <= t.indexOf("%") ? "%" : "px", t = t.replace(l, ""), s = Number(e.style[n].replace(i, "").replace(a, "").replace(l, "")), c = (t - s) / o * u, setTimeout(function t() { o -= u, s += c, e.style[n] = i + s + l + a, 0 < o ? setTimeout(t, u) : r() }, u)), F || Ci()
                } : function() {
                    re = [];
                    var t = {};
        ...
        function yn() {
            ...
            }), Ai(function() { zn(Gi(t), function() { L = !0 }) }), ln("autoHeight") && (t = In(me, Math.min(me + Wt - 1, le - 1))), ae ? gn() : Ai(function() { zn(Gi(t), gn) })) : (W && $n(), bn(), wn())
        }
        ...
        function ri(t, e) {
            ...
            if (Gt) { if (me === ge && -1 === e) return void oi("last", t); if (me === xe && 1 === e) return void oi("first", t) }
        ...
        function bi(t) {
            ...
            St && (e = vi(t), Lt.x = e.clientX, Lt.y = e.clientY, W ? Ht = Ht || Ai(function() {
                ! function t(e) {
                    ...
                    Ni(Ht);
                    St && (Ht = Ai(function() { t(e) }));
                    "?" === Ce && (Ce = gi());
                    if (Ce) {
                        !Ue && mi(e) && (Ue = !0);
                        try { e.type && Ee.emit(mi(e) ? "touchMove" : "dragMove", Ei(e)) } catch (t) {}
                        var n = Bt,
                            i = Ot(Lt, Nt);
        ...
        function wi(i) {
            var t, a, n;
            St && (Ht && (Ni(Ht), Ht = null), W && Jn(V, ""), St = !1, t = vi(i), Lt.x = t.clientX, Lt.y = t.clientY, a = Ot(Lt, Nt), Math.abs(a) && (mi(i) || Ui(n = hi(i), { click: function t(e) { yi(e), _i(n, { click: t }) } }), W ? Ht = Ai(function() {
                if (F && !Dt) {
                    var t = -a * Wt / (Pt + It),
